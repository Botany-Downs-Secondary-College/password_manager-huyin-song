...
while True: 
    ...
    if chosen_mode == "1": # If the user chose mode 1
        print("option 1 was chosen") # States the mode chosen, actual modes yet to be added
    elif chosen_mode == "2": # If the user chose mode 2
        print("option 2 was chosen")
    elif chosen_mode == "3": # If the user chose mode 3
        print("option 3 was chosen")
        break # Lets the user out of the code if they chose mode 3 (Exit the code)
    else:
        print("That was incorrect man") # If the user chose something other than the 3 available modes, tells them its incorrect

print("Thanks for using the programme") # Gives the user a goodbye message for exiting the code from mode 3